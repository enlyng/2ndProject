...
@WebServlet("/plantcare/noticelist_customer.do")
public class listController_notice_customer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<BoardDTO> boardLists = dao.noticeListpage_customer(map);
		//커넥션 풀에 자원 반납
		dao.close();
		...
		req.getRequestDispatcher("./Customer_notice.jsp").forward(req, resp);
