...
<html lang="en">
        ...
        <!-- <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="utilities-animation.jsp"
                >Animations</a
              >
        ...
        <!-- <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="forgot-password.jsp"
                >Forgot Password</a
              >
 ...
 -->
        ...
        <li class="nav-item">
            ...
            <div id="collapseTabled" class="collapse" aria-labelledby="headingPages"
                data-parent="#accordionSidebar">
                  <!-- <div class="bg-white py-2 collapse-inner rounded">
                      ...
                      <a class="collapse-item" href="Contact.jsp">Contact</a>
