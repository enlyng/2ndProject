                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="../plantcare/login.do" method="post">
                                        ...
                                        <div class="form-group was-validated">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" name="userpwd" placeholder="Password" required>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="../plantcare/regist.do">회원가입</a>
                                    </div>
                                </div>
                            </div>
                        </div>
