    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                src="https://www.changemaker.kr/images/mobile/main/logo.png"
                style="width: 70px"
              /></div>
            </a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTables" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../plantcare/noticelist_admin.do" active>Notice</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">공지 작성하기</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                            <form name="writeFrm" method="post" enctype="multipart/form-data" action="../plantcare/noticewrite.do" onsubmit="return validateForm(this);">
							...
							<input type="hidden" name="prevSfile" value="${dto.sfile }" />
								...
								<tr>
									<td>제목</td>
									<td>
										<input type="text" class="form-control" name="title" style="width:90%;" value="${dto.title }" />
									</td>
								</tr>
								<tr>
									<td>내용</td>
