...
<div class = "qna_create">
    <form class = "qna_form" method="POST" action = "../plantcare/qnaedit_customer.do">
        ...
        <input type="hidden" name="_token" value="fP5R1JpvIvX390HYV01ssn0DmzWDn5R9TtAQC7CW">        <table class = "qna_table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="tel" name="phone" value="${dto.phone }" required></td>
                    <td class = "qna_tag_name">비밀번호<span>*</span></td>
                    <td><input type="password" name="pass" value="${dto.pass }" required></td>
                </tr>
                <tr>
                    <td class = "qna_tag_name">제목<span>*</span></td>
                    <td colspan="3"><input type="text" name="title" value="${dto.title }" required></td>
                </tr>
                <tr>
                    <td class = "qna_tag_name">내용<span>*</span></td>
                    <td colspan="3"><textarea rows='10' name = "content" required>${dto.content }</textarea></td>
                </tr>
            </tbody>
        </table>
