...
<div class="row cont_qna cont_news">
   ...
   <div class="viewMore_btn cursor"><a href="../plantcare/pass.do?mode=edit&idx=${param.idx }"><span>Go for Edit</span></a></div>
   <div class="viewMore_btn cursor"><a href="../plantcare/pass.do?mode=delete&idx=${param.idx}"><span>&nbsp;Remove</span></a></div>
   <div class="viewMore_btn cursor"><a href="../plantcare/qnalist_customer.do"><span>Back to list</span></a></div>
